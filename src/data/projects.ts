...
export const projects: ICard[] = [
  {
    title: "Web Chess",
    description:
      "This is a beautiful chess platform for chess lovers and friends.",
  ...
  },
  {
    title: "PDF Library",
    description:
      "This website allows users to conveniently store and view PDF books and sheet music, anywhere.",
  ...
  },
  {
    ...
    description:
      "This website is built to easily track, compute, and lookup rules for Chinese Mahjong Game.",
  ...
  },
  {
    ...
    description:
      "This is a data analysis website that helps UCSB students determine which classes to signup first before seats run out.",
  ...
  },
  {
    title: "Gaucho Rides",
    description:
      "This is a cross-platform mobile application that provides a convenient and secure way for UCSB students to arrange rides with peers.",
    product: "",
  ...
  },
  {
    ...
    description:
      "This website is built to display my side projects, music recordings, and other hobbies.",
  ...
  },
  {
    ...
    product:
      "https://chrome.google.com/webstore/detail/chrome-editor/kefkdcgjkbijkajfmjochhmikmpmkofg?utm_source=chrome-ntp-icon",
  ...
  },
  {
    title: "Disk Galaxy",
    description:
      "This is a 2D shooting game made using SFML and C++. You can fight against AI enemies.",
    product: "",
